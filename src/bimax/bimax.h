...
//  long  i;
//  FILE *fptr;
//  fptr = fopen( "outputs/BIMAXResult.txt", "a" );
//
//  biclusterCounter++;
...
//    fprintf( fptr, "label1_%d\t", rows[i].originalRowNumber + 1L ); 
...
//} /* readInDataMatrix */
//
//int bimaxMain( char input[256], int bicCount )
//{
//  biclusterCount = bicCount;
//  FILE  *fp;
//  FILE *fptr;
//  fptr = fopen( "outputs/BIMAXResult.txt", "w" );
//
//  cout << "/**************************************************/" << endl;
